...
@section('content')
    <section class="container">
        <h2>Agregar Materia <div class="float-end"> {{ Auth::user()->name }}</div></h2>
        <hr>
        @if ($errors->any())
        ...
        <form action="{{ route('materia.store') }}" method="post">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="claveMat" name="ClaveMat" maxlength="8" required>
                </div>
                <div class="col">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <input type="text" class="form-control" id="NombreAbreviado" name="NombreAbreviado" maxlength="25" required>
                </div>
                <div class="col">
