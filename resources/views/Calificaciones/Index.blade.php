...
<section class="container">
    <h2>Módulo para Calificaciones <div class="float-end"> Editar Calificación <a href="{{ route('calificaciones.edit') }}"><i class='bx bx-chevron-right-circle'></i></a></div></h2>
    <hr>
    <form class="container justify-content-center d-flex" role="search">
        <div class="row mb-1">
            <div class="col">
                <select name="carrera" id="carrera" class="form-select" aria-label="Default select example" required>
        ...
        @foreach ($alumnos as $item)
            <tbody>
                <tr>
                    ...
                    <td>{{ $item->alumno }}</td>
                    <td>
                        @can('calificaciones-create')
                            <a class="btn btn-primary" href="{{ route('calificaciones.create', $item->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Calificaciones"><i class='bx bxs-message-square-add'></i></a>
                        @endcan
                    </td>
                </tr>
            </tbody>
