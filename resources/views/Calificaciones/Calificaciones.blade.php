...
<h2>Capturar calificaciones <div class="float-end"> {{ Auth::user()->name }}</div></h2>
<hr>
@if ($errors->any())
...
@endif
<form action="{{ route('calificaciones.store',$alumno) }}" method="post">
    @csrf
    <div class="row mb-3">
        <div class="col">
            <label class="form-label is-required" for="form6Example3">Seleccciona el Periodo:</label>
            <select name="cicloEscolar" class="form-select" aria-label="Default select example" >
                <option></option>
        ...
        <div class="col">
            <label class="form-label is-required" for="form6Example3">Seleciona la Unidad</label>
