...
<link rel="stylesheet" href="https://cdn.datatables.net/responsive/2.4.1/css/responsive.bootstrap5.min.css">
    <section class="container">
        <h2><a href="{{ route('asistencia') }}"><i class='bx bx-chevron-left-circle'></i></a> Editar Inasistencia</h2>
        <hr>
        ...
        <table id="tabla" class="table table-sm table-dark">
            ...
            @foreach ($asistencia as $item)
                <tbody>
                    <tr>
                        <td>
                            @can('inasistencia-edit')
                                <a class="btn btn-primary" href="{{ route('asistencia.editar',$item->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Editar"><i class='bx bxs-edit'></i></a>
                            @endcan
                            @can('inasistencia-delete')
                                <a class="btn btn-danger" href="{{ route('asistencia.eliminar', $item->id) }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Eliminar">
